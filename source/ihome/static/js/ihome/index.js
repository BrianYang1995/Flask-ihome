...
$(document).ready(function(){
    $.get("/api/v1.0/session", function(data) {
        if (data.errcode == '0') {
            $(".top-bar>.user-info>.user-name").html(data.errmsg);
    ...
    $.get("/api/v1.0/house/index", function(data){
        if (data.errcode =="0") {
            $(".swiper-wrapper").html(template("swiper-houses-tmpl", {houses:data.data.houses}));
