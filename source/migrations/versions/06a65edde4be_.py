...
Revision ID: 06a65edde4be
Revises: 
Create Date: 2018-08-19 09:36:10.077828
...
def upgrade():
    ...
    sa.Column('beds', sa.String(length=32), nullable=True),
    ...
    sa.ForeignKeyConstraint(['usr_id'], ['ih_user_profile.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('WAIT_ACCEPT', 'WAIT_PAYMENTPAID', 'WAIT_COMMENT', 'COMPLETE', 'CANCELED', 'REJECTED'), nullable=True),
    sa.Column('comment', sa.Text(), nullable=True),
    sa.Column('trade_no', sa.String(length=128), nullable=True),
    sa.ForeignKeyConstraint(['house_id'], ['ih_house_info.id'], ),
    sa.ForeignKeyConstraint(['use_id'], ['ih_user_profile.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
